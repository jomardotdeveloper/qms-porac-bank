                ...
                <div class="row layout-top-spacing date-table-container">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <h4 class="table-header">All Roles</h4>
                            <div class="table-responsive mb-4">
                                <table id="basic-dt" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="{{route('roles.show', ['role' => $role])}}" class="text-primary">{{ $role->name }} </a></td>
                                            <td>{{ $role->branch->name }}</td>
                                            <td><a href="{{route('roles.edit', ['role' => $role])}}" title="Edit" class="font-20 text-primary"><i class="las la-edit"></i></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
