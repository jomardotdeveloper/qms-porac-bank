...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><span>Cash Deposits</span></li>
    </ol>
</nav>
@endsection
@section("content")
                ...
                <div class="row layout-top-spacing date-table-container">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            @endif
                        <h4 class="table-header">All Cash Deposits</h4>
...
<div id="fadeinModal" class="modal animated fadeInDown" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('deposits.export')}}" method="POST" enctype="multipart/form-data">
                @csrf
