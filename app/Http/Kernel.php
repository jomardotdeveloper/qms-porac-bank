...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        'checkaccount' => \App\Http\Middleware\checkIfAllowedAccount::class,
        'checkcontrol' => \App\Http\Middleware\checkIfAllowedControl::class,
        'checkreport' => \App\Http\Middleware\checkIfAllowedReport::class,
        'checksetting' => \App\Http\Middleware\checkIfAllowedSetting::class,
